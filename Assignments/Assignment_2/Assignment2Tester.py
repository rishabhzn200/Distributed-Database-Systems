...
if __name__ == '__main__':
    try:
        ...
        Assignment2.RangeQuery(1.0, 4.0, con, "./rangeResult.txt");
        # Assignment2.RangeQuery(0, 5, con, "./rangeResult.txt");
        # Assignment2.RangeQuery(1, 5, con, "./rangeResult.txt");
        # Assignment2.RangeQuery(1, 4, con, "./rangeResult.txt");
        # Assignment2.RangeQuery(2, 5, con, "./rangeResult.txt");
        #Assignment2.RangeQuery(1,4,con, "./rangeResult.txt");

        # Calling PointQuery
        print "Performing Point Query"
        Assignment2.PointQuery(1, con, "./pointResult.txt");
